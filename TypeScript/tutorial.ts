/*************************************************TYPESCRIPT*************************************************
1. INSTALL Node.js to get npm and to run typescript code on terminal
2. Install typescript: npm install -g typescript
3. Create a ts file and transpile it to js code: tsc main.ts
4. Run the generated code: node main.js or tsc main.ts | main.js

There are some library functions like string.endsWith that are available in newer versions.  To allow,
tsc --lib es6 main.ts

You may get compilation errors as console.log isn't defined in es6.To allow: npm install @types/node
This will create a folder "node_modules"
**************************************************TYPESCRIPT************************************************/
...
let log1 = function (msg: string, msg2?:string, msg3="defaultVal") { console.log(msg); }   
...
//or
function myAdd3(x: number, y: number): number { return x + y; }



//passing callbacks
function fn(x: () => void) { x(); }
fn(() => { console.log("call back func"); });
...
let drawPoint3 = (point: IPoint) => { }
let getDistance = (pointA: IPoint, pointB: IPoint) => { }

//**********CLASSES**********

//Above is not cohesive and so we need classes
...
class Point implements IPoint {
    ...
    drawPoint(): void { console.log("x1: " + this.x); }
    drawPoint2 = () =>  { console.log("x2: " + this.x); }
}
